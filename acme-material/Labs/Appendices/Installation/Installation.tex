...
\item Spyder IDE: \url{https://www.spyder-ide.org/} (an IDE similar to Matlab)
...
As an alternative to the procedure described that requires a browser to
work with the notebooks,
\href{https://code.visualstudio.com/docs/python/jupyter-support}{VS
Code has native support for Jupyter notebooks}. Try opening a notebook
file, eg, \lstinline{code mynotebook.ipynb}.
