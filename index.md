...
| 2/2  | Set Cover: Primal-Dual <br> Set Cover: Greedy                                                                                                          | 1.5 [WS] <br> 1.6 [WS] <!--- [Exercises]({% post_url 2018-01-10-sheet1 %}#sheet2)---> |
|------+--------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------|
| 5/2  | [Exercises]({% post_url 2018-01-23-exercises %}) <br> Set Cover: Randomized LP-rounding                                                            | 1.7 [WS]                                                                    |
...
| 18/4 | Scheduling: Complexity                                                                                                                                 | 2.3 [WS]                                                                    |
| 19/4 |                                                                                                                                                        |                                                                             |
|------+--------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------|
