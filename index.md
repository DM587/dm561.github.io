...
| 24/4         | Scheduling: Classification                                                                                                                             | [Slides][28]; [Slides][29]                                                                                         |
|--------------+--------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------|
| 30/4         | Scheduling: Complexity                                                                                                                                 |                                                                                                                    |
...
[28]: {{ "/assets/dm865-scheduling-class.pdf" | absolute_url }}
[29]: {{ "/assets/dm865-scheduling-complex.pdf" | absolute_url }}
