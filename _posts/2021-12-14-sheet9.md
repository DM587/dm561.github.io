...
$A\ensuremath{\mathbf{x}}\leq \ensuremath{\mathbf{b}}$, $A\in
\ensuremath{\mathbb{R}}^{m\times n}, \ensuremath{\mathbf{x}} \in \ensuremath{\mathbb{R}}^n$,
...
-   How many constraints are *active* in a *vertex* of a polyhedron
    $A\ensuremath{\mathbf{x}}\leq \ensuremath{\mathbf{b}}$,
    $A\in \ensuremath{\mathbb{R}}^{m\times n}, \ensuremath{\mathbf{x}} \in \ensuremath{\mathbb{R}}^n$?\
