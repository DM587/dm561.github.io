...
We have mentioned that for solving a system of linear equations
...
Describe the computational complexity of carrying out the Gram-Schmidt
orthogonalization, which is the bottleneck of method 3. 

Compare then the computational complexity of the first three methods.
